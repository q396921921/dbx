...
describe("VictoriaMetrics data grid filters", () => {
  it("does not expose SQL filter modes for MetricsQL results", () => {
    const modes: DataGridContextFilterMode[] = ["equals", "not-equals", "is-null", "is-not-null", "is-blank", "is-not-blank", "like", "not-like", "less-than", "greater-than", "in", "not-in", "between", "not-between"];
