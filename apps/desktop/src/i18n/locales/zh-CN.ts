...
export default withEnglishFallback({
  ...
  grid: {
    ...
    allLoaded: "已全部加载",
    fetchAllRows: "加载全部数据行",
    fetchAllRowsStop: "停止加载",
    fetchAllRowsProgress: "已加载 {loaded} / 共 {total} 行",
    fetchAllRowsProgressUnknown: "已加载 {loaded} 行",
    fetchAllRowsConfirmMessage: "将把该查询的全部数据行加载到结果网格并保留在内存中（共 {total} 行）。",
    fetchAllRowsConfirmLarge: "该结果集共 {total} 行，超过 {threshold} 行。全部载入会占用大量内存，可能导致界面卡顿。",
    fetchAllRowsConfirmUnknown: "无法预先确定总行数，将持续加载直到读完或达到上限 {cap} 行。",
    fetchAllRowsConfirmDetails: "最多加载 {cap} 行，可在「设置 → 数据 → 查询结果最大行数」中调整。",
    fetchAllRowsSuppress: "以后加载全部数据行不再提示",
    fetchAllRowsLimitReached: "已达到查询结果最大行数（{cap} 行），可在「设置 → 数据 → 查询结果最大行数」中调整。",
