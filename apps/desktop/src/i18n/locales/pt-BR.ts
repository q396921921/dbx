...
export default withEnglishFallback({
  ...
  grid: {
    ...
    fetchAllRows: "Carregar todas as linhas",
    fetchAllRowsStop: "Parar carregamento",
    fetchAllRowsProgress: "{loaded} de {total} linhas carregadas",
    fetchAllRowsProgressUnknown: "{loaded} linhas carregadas",
    fetchAllRowsConfirmMessage: "Carrega todas as linhas desta consulta na grade de resultados e as mantém na memória ({total} linhas no total).",
    fetchAllRowsConfirmLarge: "Este resultado tem {total} linhas, mais que {threshold}. Carregar tudo usará bastante memória e pode deixar a interface sem resposta.",
    fetchAllRowsConfirmUnknown: "O total de linhas ainda não é conhecido. As linhas continuarão sendo carregadas até não haver mais ou até atingir o limite de {cap} linhas.",
    fetchAllRowsConfirmDetails: "Carrega no máximo {cap} linhas. Ajuste isso em Configurações → Dados → Máximo de linhas do resultado.",
    fetchAllRowsSuppress: "Não perguntar novamente ao carregar todas as linhas",
    fetchAllRowsLimitReached: "Limite máximo de linhas do resultado atingido ({cap} linhas). Ajuste isso em Configurações → Dados → Máximo de linhas do resultado.",
