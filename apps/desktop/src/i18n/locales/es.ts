...
export default withEnglishFallback({
  ...
  grid: {
    ...
    fetchAllRows: "Cargar todas las filas de datos",
    fetchAllRowsStop: "Detener carga",
    fetchAllRowsProgress: "Cargadas {loaded} de {total} filas",
    fetchAllRowsProgressUnknown: "Cargadas {loaded} filas",
    fetchAllRowsConfirmMessage: "Se cargarán todas las filas de datos de esta consulta en la cuadrícula de resultados y se mantendrán en memoria ({total} filas en total).",
    fetchAllRowsConfirmLarge: "Este resultado tiene {total} filas, más de {threshold}. Cargarlo todo usará mucha memoria y puede hacer que la interfaz deje de responder.",
    fetchAllRowsConfirmUnknown: "Aún no se conoce el número total de filas. Se seguirán cargando filas hasta que no queden más o se alcance el límite de {cap} filas.",
    fetchAllRowsConfirmDetails: "Carga como máximo {cap} filas. Ajusta esto en Ajustes → Datos → Máximo de filas del resultado.",
    fetchAllRowsSuppress: "No volver a preguntar al cargar todas las filas",
    fetchAllRowsLimitReached: "Se alcanzó el límite máximo de filas del resultado ({cap} filas). Ajusta esto en Ajustes → Datos → Máximo de filas del resultado.",
