...
export default withEnglishFallback({
  ...
  grid: {
    ...
    allLoaded: "すべて読み込み済み",
    fetchAllRows: "すべての行を読み込み",
    fetchAllRowsStop: "読み込みを停止",
    fetchAllRowsProgress: "{loaded} / {total} 行を読み込み済み",
    fetchAllRowsProgressUnknown: "{loaded} 行を読み込み済み",
    fetchAllRowsConfirmMessage: "このクエリの全行を結果グリッドに読み込み、メモリ上に保持します（合計 {total} 行）。",
    fetchAllRowsConfirmLarge: "この結果セットは {total} 行あり、{threshold} 行を超えています。すべて読み込むと大量のメモリを消費し、UIが応答しなくなる可能性があります。",
    fetchAllRowsConfirmUnknown: "総行数はまだわかりません。データがなくなるか、上限の {cap} 行に達するまで読み込みを続けます。",
    fetchAllRowsConfirmDetails: "最大 {cap} 行まで読み込みます。設定 → データ → クエリ結果の最大行数 で変更できます。",
    fetchAllRowsSuppress: "全行読み込み時に今後確認しない",
    fetchAllRowsLimitReached: "クエリ結果の最大行数（{cap} 行）に達しました。設定 → データ → クエリ結果の最大行数 で変更できます。",
